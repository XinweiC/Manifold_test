...
class MessagingTest : public CppUnit::TestFixture {
        ...
        void test_messaging()
	{
	    ...
	    Manifold :: ConnectTime(c1, MyObj1::C1_IN, c0, MyObj1::C0_OUT, &MyObj1::process_incoming, MyObj1::C0_OUT_LATENCY);
...
int main(int argc, char** argv)
{
	...
	Manifold :: Init(argc, argv, Manifold::MIXED, SyncAlg::SA_CMB);
