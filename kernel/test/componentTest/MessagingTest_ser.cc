...
class MessagingTest : public CppUnit::TestFixture {
	...
	//==========================================================================
	//! @brief Test messaging with serialized data.
	//!
	//! Create 2 MPI tasks; Task 0 schedules N events, each of which sends a message
	//! to Task 1; after receiving, Task 1 echos the message contents back using
	//! MPI_send(). Task 0 verifies the data that Task 1 has received.
	//==========================================================================
        void test_messaging_0()
	{
	...
	//! @brief Test messaging with serialized data.
	//!
	//! Create 2 MPI tasks; Task 0 schedules N events all at the same tick, each of
	//! which sends a message to Task 1; after receiving, Task 1 echos the message
	//! contents back using MPI_send(). Task 0 verifies the data that Task 1 has received.
	//==========================================================================
        void test_messaging_1()
	{
	...
	static CppUnit::Test* suite()
	{
	    ...
	    mySuite->addTest(new CppUnit::TestCaller<MessagingTest>("test_messaging_0", &MessagingTest::test_messaging_0));
	    mySuite->addTest(new CppUnit::TestCaller<MessagingTest>("test_messaging_1", &MessagingTest::test_messaging_1));
