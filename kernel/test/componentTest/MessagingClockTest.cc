...
class MyObj1 : public Component {
	...
	#endif
    public:
        static const int C0_OUT = 2; //port number
        static const int C1_IN = 5; //port number
...
class MessagingTest : public CppUnit::TestFixture {
        ...
        void test_messaging()
	{
	    ...
	    Manifold :: ConnectClock(c1, MyObj1<T>::C1_IN, c0, MyObj1<T>::C0_OUT, Clock1, &MyObj1<T>::process_incoming, MyObj1<T>::C0_OUT_LATENCY);
