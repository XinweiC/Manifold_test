...
class ComponentTest : public CppUnit::TestFixture {
	...
	{
	    CompName name("testGetComponentId_1");
	    CompName noname("None");
	    ...
	    MyComp1* comp2 = Component :: GetComponent<MyComp1>(name.get_name());
            MyComp1* comp3 = Component :: GetComponent<MyComp1>(noname.get_name());
	    ...
	    CPPUNIT_ASSERT(noname.get_name() == comp1->getComponentName()); 
	    CPPUNIT_ASSERT(name.get_name() == comp2->getComponentName());
	}
	...
	{   
	    CompName name("testGetComponentId_2");
	...
	void testIsLocal()
	{
            CompName name1("testIsLocal1");
	    CompName name2("testIsLocal2");
            CompName noname("None");
	    ...
	    CPPUNIT_ASSERT_EQUAL(true, Component :: IsLocal(name1.get_name()));
	    CPPUNIT_ASSERT_EQUAL(false, Component :: IsLocal(noname.get_name()));
	    //In the sequential kernel, all components are deemed local
	    CPPUNIT_ASSERT_EQUAL(false, Component :: IsLocal(id2));
	    CPPUNIT_ASSERT_EQUAL(false, Component :: IsLocal(name2.get_name()));
	}
	...
	static CppUnit::Test* suite()
	{
	    ...
	    //mySuite->addTest(new CppUnit::TestCaller<ComponentTest>("testSend_1", &ComponentTest::testSend_1));
