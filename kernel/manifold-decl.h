...
public:
  ...
  // Static variables
...
#ifdef KERNEL_UTEST
#ifdef NO_MPI
    static void CreateScheduler(SchedulerType t)
    {
        delete TheScheduler;
	switch(t) {
	    case TICKED:
    ...
    static void CreateScheduler(SchedulerType t,SyncAlg::SyncAlgType_t syncAlgType, Lookahead::LookaheadType_t lookaheadType=Lookahead::LA_GLOBAL)
    {
	delete TheScheduler;
	switch(t) {
	    case TICKED:
