...
void MCFrontEnd::update_energy(InputParameter McPAT_input, TechnologyParameter McPAT_tech)
{
  *g_ip = interface_ip = McPAT_input;
  ...
  frontendBuffer->update_energy(McPAT_input,McPAT_tech);
  readBuffer->update_energy(McPAT_input,McPAT_tech);
  writeBuffer->update_energy(McPAT_input,McPAT_tech);
  MC_arb->update_energy(McPAT_input,McPAT_tech);
}
