 ...
 */
public class MyRenderer extends ShapeRenderer {
     ...
     */
    public MyRenderer(String textField) {
     ...
     * drawn.
     */
    public MyRenderer(String textField, String imageField) {
    ...
    protected String getText(VisualItem item) {
        ...
        if ( item.canGetString(m_text)){
        	return item.getString(m_text);
        }   	
        return s;
    }
